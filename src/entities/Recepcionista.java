...
*/
// código do Davi(ainda incompatível)
package entities;
...
// modo de uso:
// qualquer outra classe no pacote tem acesso as listas estáticas contidas em Recepcionista, basta acessar Recepcionista.<nome da lista estática>
// new Recepcionista(<nome>) é a unica forma de instanciar
// o hospede que quiser ser atendido deve chamar Recepcionista.lodgeRequest(<hospede>) e aguardar receber true caso tenha quartos vagos e false caso não tenha quartos vagos
